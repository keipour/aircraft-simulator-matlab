classdef math
    ...
    methods(Static)
        ...
        function in = InConvexHull(testpts, xyz, tess, tol)
            % InConvexHull: tests if a set of points are inside a convex hull
            % usage: in = InConvexHull(testpts,xyz)
            % usage: in = InConvexHull(testpts,xyz,tess)
            % usage: in = InConvexHull(testpts,xyz,tess,tol)
            %
            % arguments: (input)
            ...
            %  in = InConvexHull(testpoints,xy,tess)
            %
            % in = 
            %      1
            %      0
            ...
            %
            %   warning('off','InConvexHull:degeneracy')
            %
            ...
            switch p
                case 2
                    ...
                    if sum(degenflag)>0
                        warning('InConvexHull:degeneracy',[num2str(sum(degenflag)), ...
